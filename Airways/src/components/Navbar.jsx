            ...
            <nav>
                <div className="top-nav-bar">
                    <div className="left-side">
                        <ul>
                            <li>
                                <a href="https://www.facebook.com/namoairways/" target="_blank" className="icon" rel="noopener noreferrer">
                            ...
                            <li>
                                <a href="https://x.com/AirwaysNamo" target="_blank" className="icon" rel="noopener noreferrer">
                                    <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="100" height="100" viewBox="0 0 48 48">
                            ...
                            <li>
                                <a href="https://www.instagram.com/namoairways/?hl=en" target="_blank" className="icon" rel="noopener noreferrer">
                                    <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="100" height="100" viewBox="0 0 48 48">
                            ...
                            <li>
                                <a href="https://www.linkedin.com/company/namo-airways-services-india-pvt-ltd/posts/?feedView=all" target="_blank" className="icon" rel="noopener noreferrer">
                                    <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="100" height="100" viewBox="0 0 48 48">
