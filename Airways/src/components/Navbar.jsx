            ...
            <nav>
                <div className="top-nav-bar">
                    <div className="left-side">
                        <ul>
                            <li> <a href="https://facebook.com/" target="_blank" class="icon"><svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="100" height="100" viewBox="0 0 48 48">
                           ...
                           <i class="fa-brands fa-x-twitter"></i></a></li>
                            <li> <a href="https://instagram.com/" target="_blank" class="icon"><svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="100" height="100" viewBox="0 0 48 48">
                            ...
                            <li> <a href="https://linkedin.com/" target="_blank" class="icon"><svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="100" height="100" viewBox="0 0 48 48">
