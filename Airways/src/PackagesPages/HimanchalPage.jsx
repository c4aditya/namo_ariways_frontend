        ...
        <>
                ...
                <div className="left-side-top-package-class">
                    <div className="content-left-side-package-class">
                        <div className="heading-left-side">
                            <h1>Himanchal Pradesh Packages Tour</h1>
                        </div>
                        <div className="para-left-side">
                            <p>
                                Explore the natural splendor of Himachal Pradesh, where majestic mountains, pine-covered valleys, and
                                refreshing rivers create a perfect escape. Enjoy adventure sports in Solang, peaceful walks in Shimla,
                                and the vibrant culture of Dharamshala. Experience cozy hilltown charm, breathtaking landscapes, and the
                                serene beauty that makes Himachal a true paradise for nature lovers.
                            </p>
            ...
            <section className="main-section-package">
                <div className="package-name-top-title">
                    <p className="package-name-top-title-heading">Himanchal Pradesh Holiday's Packages</p>
                    <p className="package-name-top-title-package">Showing all {packagedata.length} packages for Himanchal Pradesh</p>
                </div>
