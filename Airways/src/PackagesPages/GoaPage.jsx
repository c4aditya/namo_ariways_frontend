    ...
    <>
        ...
        <div className="left-side-top-package-class">
          <div className="content-left-side-package-class">
            ...
            <div className="para-left-side">
              <p>
                Relax on Goa’s sun-kissed beaches, enjoy thrilling water sports, and savor delicious seafood.
                Discover vibrant nightlife, historic forts, and the unforgettable charm of India’s top coastal destination.
              </p>
            </div>
          </div>
      ...
      <section className="main-section-package">
        <div className="package-name-top-title">
          ...
          <p className="package-name-top-title-package">Showing all {packagedata.length} packages for Goa</p>
        </div>
