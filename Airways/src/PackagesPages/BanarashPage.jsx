import banarashData from "./Banarashdata";
        ...
        <>
            ...
            <div className="top-aboutus">
                ...
                <div className="image-poster-details">
                    <img src="https://res.cloudinary.com/dxgmovaih/image/upload/v1751890377/White_And_Orange_Varanasi_Travel_Vlog_YouTube_Thumbnail_1_qhbar2.png" />
                </div>

            </div>
            <div className="data-filet">
                <div className="main-class-of-pachage-details">
                    {banarashData.map((data) => (
