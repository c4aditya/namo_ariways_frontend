import goaPackages from "./Banarashdata";
        ...
        <div className="left-side-top-package-class">
          <div className="content-left-side-package-class">
            <div className="heading-left-side">
              <h1>Varanasi Packages Tour</h1>
            </div>
            <div className="para-left-side">
              <p>
  Experience the spiritual heart of India in Varanasi, where sacred Ganga ghats, ancient temples, and vibrant streets create an unforgettable atmosphere. Witness the mesmerizing Ganga Aarti, explore narrow lanes filled with culture and tradition, and feel the deep sense of peace that surrounds this holy city. From its timeless rituals to its rich heritage, Varanasi offers a truly soulful and enlightening journey.
</p>
      ...
      <section className="main-section-package">
        <div className="package-name-top-title">
          <p className="package-name-top-title-heading">Varanasi Holiday's Packages</p>
          <p className="package-name-top-title-package">Showing all {packagedata.length} packages for Varanasi</p>
        </div>
