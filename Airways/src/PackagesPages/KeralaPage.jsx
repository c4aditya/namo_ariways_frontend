import goaPackages from "./KeralaData";
    ...
    <>
        ...
        <div className="left-side-top-package-class">
          <div className="content-left-side-package-class">
            <div className="heading-left-side">
              <h1>Kerla Packages Tour</h1>
            </div>
            <div className="para-left-side">
              <p>
               Escape to Kerala’s serene backwaters, lush green landscapes, and tranquil beaches. Cruise through palm-fringed canals, unwind with Ayurvedic wellness therapies, and savor authentic South Indian flavors. Explore misty hill stations, vibrant wildlife sanctuaries, and the cultural charm that makes Kerala India’s most peaceful paradise.
              </p>
            </div>
          </div>
      ...
      <section className="main-section-package">
        <div className="package-name-top-title">
          <p className="package-name-top-title-heading">Kerla Holiday's Packages</p>
          <p className="package-name-top-title-package">Showing all {packagedata.length} packages for Kerla</p>
        </div>
