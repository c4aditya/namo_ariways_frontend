import goaPackages from "./UttarakhsndData";
        ...
        <>
                ...
                <div className="left-side-top-package-class">
                    <div className="content-left-side-package-class">
                        <div className="heading-left-side">
                            <h1>Uttarakhand  Packages Tour</h1>
                        </div>
                        <div className="para-left-side">
                          <p> Discover the breathtaking beauty of Uttarakhand, where towering Himalayan mountains, lush pine forests, and sparkling rivers create a peaceful escape. Enjoy thrilling river rafting in Rishikesh, peaceful nature walks in Mussoorie, and the mesmerizing lake views of Nainital. With its spiritual atmosphere, fresh mountain air, and stunning landscapes, Uttarakhand is truly a paradise for nature lovers. </p>
            ...
            <section className="main-section-package">
                <div className="package-name-top-title">
                    <p className="package-name-top-title-heading">Uttarakhand, Holiday's Packages</p>
                    <p className="package-name-top-title-package">Showing all {packagedata.length} packages for Uttarakhand</p>
                </div>
