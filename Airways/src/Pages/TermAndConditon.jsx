                ...
                <div className="main-terms-container">
                    ...
                    <div className="term-section">
                        ...
                        <div className="term-content">
                            ...
                            <ul>
                                <li><span className="color">10%</span> of the package amount must be paid in advance at the time of booking.</li>
                                <li><span className="color">45%</span> of the total amount must be paid within <span className="color">3</span> to <span className="color">5</span> days of booking.</li>
                                <li><span className="color">25%</span> of the total amount must be paid after hotel & cab confirmation.</li>
                                <li>The remaining <span className="color">20%</span> must be paid on the first day of the trip.</li>
                    ...
                    <div className="term-section">
                        ...
                        <div className="term-content">
                            <ul>
                                ...
                                <li>No refund after <span className="color">48</span> hours of booking.</li>
                                <li>If the departure date is within <span className="color">10</span> days, full payment must be made at the time of booking.</li>
                            </ul>
                        </div>
                    </div>
                    ...
                    <div className="term-section">
                        ...
                        <div className="term-content">
                            <ul>
                                <li><span className="color">25%</span> cancellation fee if cancellation is requested <span className="color">30-40</span> days before departure.</li>
                                <li><span className="color">50%</span> cancellation fee if requested <span className="color">15-30</span> days before departure.</li>
                                <li>No refund if cancellation is within <span className="color">15</span> days of departure.</li>
                            </ul>
                        </div>
                    </div>
                    ...
                    <div className="term-section">
                        ...
                        <div className="term-content">
                            <ul>
                                <li>Travellers must follow the holiday package provided by <span className="color">Namo Airways</span> throughout the journey.</li>
                                <li><span className="color">Namo Airways</span> is not responsible for any unfortunate events resulting from changes made by the client during the journey.</li>
                                ...
                                <li><span className="color">Namo Airways</span> is not responsible for lost luggage or documents during travel.</li>
                                <li><span className="color">Namo Airways</span> may make changes to travel plans before or during the journey, and clients must comply.</li>
                                <li><span className="color">Namo Airways</span> reserves the right to cancel the tour of any traveller whose behaviour affects others or our staff.</li>
                    ...
                    <div className="term-section">
                        ...
                        <div className="term-content">
                            <ul>
                                ...
                                <li>E-tickets for fixed departures will be sent <span className="color">3</span> days before departure.</li>
