...
function CourseDetails() {
  ...
  // SAME function for Buy Now + Enquiry Now (type batayega)
  const handleCourseEnq = async (e, type) => {
    e.preventDefault();
    ...
    const payload = {
      ...
      courseName: formData.courseName || data?.courseTitle || "",
      enquiryType: type  // 'buy' ya 'course-enquiry'
    };

    console.log("Course enquiry payload:", payload);

    try {
      const res = await fetch(`${BASE_URL}/course/enq`, {
        method: "POST",
      ...
      console.log("Course enquiry response:", result);

      if (res.ok && result.success) {
        alert(
          type === "buy"
            ? "Buy request submitted. Our team will contact you soon."
      ...
      console.error("Course enquiry API error:", err);
        ...
        <div className="main-wr">
          <div className="wrapper">
            ...
            <div className="application-form-carrer-page acdemy-form">
              <form
                className="main-form in-acdemy-css"
                onSubmit={(e) => e.preventDefault()} // default ko roka, buttons handle karenge
              >
                <input
                ...
                <div className="buttons">
                  <button
                    className="buyNow"
                    onClick={(e) => handleCourseEnq(e, "buy")}
                  >
                    Buy Now
                  </button>
                  <button
                    className="submit"
                    onClick={(e) => handleCourseEnq(e, "course-enquiry")}
                  >
                    Enquiry Now
                  </button>
                </div>
